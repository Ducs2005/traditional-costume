    ...
    <body>
        <div class="container">
            ...
            <div class="table-responsive">
                <form action="{{route('vnpay.createPayment')}}" id="create_form" method="post">       
                    @csrf
                    <div class="form-group">
                        <label for="language">Loại hàng hóa </label>
                        <select name="order_type"  id="order_type" class="form-control" value="">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="amount"
                               name="amount" type="number" readonly  value="{{$cartTotal}}"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div hidden class="form-group">
                        ...
                        <?php 
                            $startTime = date('Y-m-d H:i:s'); // Ensure `$startTime` is defined (e.g., current time)
                            $expire = date('YmdHis', strtotime('+15 minutes', strtotime($startTime)));
                        ?>
                        <input class="form-control" id="txtexpire" name="txtexpire" value="<?php echo $expire ?>"  >   
                    </div>
                    <div hidden class="form-group">
